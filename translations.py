...
QUESTION_TRANSLATIONS = {
    "fr": {
        "CR_CA1": "J’accepte le changement tel qu’il est.",
        "CR_CD1": "Je garde pour moi ma résistance au changement.",
        "CR_CD3": "Je me retire de tout ce qui concerne le changement.",
        ...
        "CR_CR3": "J’essaie activement d’influencer ou de ralentir le changement.",
        "CR_CD2": "Je reporte la mise en œuvre du changement.",
        ...
        "Res2": "Je m’adapte facilement aux situations changeantes.",
        "Res3": "Je me remets rapidement après un revers.",
        ...
        "IAP_I2": "J’adapte volontiers mon comportement lorsque cela est nécessaire pour bien collaborer.",
        "IAP_T1": "Je suis régulièrement des formations, au travail ou en dehors, afin de maintenir mes compétences à jour.",
        "IAP_C2": "Au sein de mon équipe ou de mon service, on fait appel à moi pour proposer de nouvelles solutions.",
        "IAP_T2": "Je recherche activement toute occasion d’améliorer mon fonctionnement (formation, projet de groupe, échange avec des collègues, etc.).",
        "LO_A": "Je prends moi-même l’initiative de décider ce que j’apprends et comment je l’apprends.",
        "PB_SS1": "Je suis activement les évolutions du monde qui m’entoure afin d’identifier ce qui pourrait influencer mon travail à l’avenir.",
        "PB_SS3": "Je réfléchis à l’avance aux changements possibles dans mon organisation à la suite d’évolutions externes (par exemple le marché ou la technologie).",
        "PB_PP1": "J’essaie de développer des méthodes et des systèmes efficaces à long terme, même si cela demande davantage de temps au départ.",
        "PB_PP2": "J’essaie d’identifier la véritable cause des problèmes qui surviennent.",
        "IAP_Rx": "J’anticipe les problèmes possibles en élaborant des scénarios et des options de décision avant qu’ils ne soient nécessaires.",
        "IAP_Ix": "Je construis consciemment des relations de réseau qui nous aident, moi et les autres, à mieux absorber ou exploiter les changements futurs.",
        "IAP_WSx": "Je réduis le stress futur en améliorant les structures et les processus afin de prévenir les situations de crise.",
        "IBIncr6": "J’imagine de nouvelles façons de mieux utiliser la technologie dans mon travail.",
        ...
        "EISB4": "J’imagine de nouvelles façons de travailler pour mon organisation.",
        "VOICE": "J’exprime activement mes idées et formule des propositions sur la manière dont mon organisation peut se renouveler pour faire face aux changements futurs.",
    },
    "en": {
...
PILLAR_TRANSLATIONS = {
    "fr": {
        "VA": {"title": "Attitude face au changement", "description": "Ce pilier décrit votre réaction émotionnelle, cognitive et comportementale au changement dans votre environnement de travail.", "score_meaning": {
        ...
        "LO": {"title": "Motivation à apprendre & Développement", "description": "Ce pilier décrit dans quelle mesure vous investissez activement dans l’apprentissage et votre développement.", "score_meaning": {
